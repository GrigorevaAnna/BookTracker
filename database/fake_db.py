...
#
# # "Базы данных" в памяти (словари вместо реальной БД)
...
#         books_db[book.id] = book   # Сохраняем книгу в словарь
#
#     user_id = "user_123"
#     connections = [
...
#         ("6", BookStatus.FINISHED, 399, 3.8, "Ну норм..норм"),
#     ]
#
...
#         )
#
# # Автоматически загружаем демо-данные при импорте модуля
# init_sample_data()